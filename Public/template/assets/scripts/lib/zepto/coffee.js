define(function(require, exports, module) {
    ...
    module.exports = Zepto, function($, undefined) {
        ...
        var eventPrefix, transform, transitionProperty, transitionDuration, transitionTiming, transitionDelay, animationName, animationDuration, animationTiming, animationDelay, prefix = "", vendors = {
            Webkit: "webkit",
            Moz: "",
            O: "o"
        ...
        $.each(vendors, function(vendor, event) {
            ...
            if (duration === undefined && (duration = $.fx.speeds._default / 1e3), delay === undefined && (delay = 0)
                , $.fx.off && (duration = 0), "string" == typeof properties)cssValues[animationName] = properties, cssValues[animationDuration] = duration + "s", cssValues[animationDelay] = delay + "s", cssValues[animationTiming] = ease || "linear", endEvent = $.fx.animationEnd;
            else {
                cssProperties = [];
        ...
        $.fn.coffee = function(option) {
            ...
            var __time_val = null, __time_wind = null, __flyFastSlow = "cubic-bezier(.09,.64,.16,.94)", $coffee = $(this), opts = $.extend({}, $.fn.coffee.defaults, option), coffeeSteamBoxWidth = opts.steamWidth, $coffeeSteamBox = $('<div class="coffee-steam-box"></div>').css({
