define(function(require, exports, module) {
    var $ = require("lib/zepto/zepto"), $ = require("lib/zepto/touch"), $ = require("lib/zepto/coffee"), objectUtil = require("system/util/objectUtil"), GlobalAudio = function($item) {
        this._$globalAudio = $item, this._$tip = $("<span></span>"), 
//        this.audio = this._$globalAudio.find("audio")[0],
        this.audio = parent.document.getElementById('audio'),
       ...
       if (this.audio == null){
        ...
        this._$globalAudio.append(this._$tip), this._$globalAudio.coffee({
            steams: ['<img src="http://tj.uooji.com/static/img/musicalNotes.png"/>', '<img src="http://tj.uooji.com/static/img/musicalNotes.png"/>', '<img src="http://tj.uooji.com/static/img/musicalNotes.png"/>', '<img src="http://tj.uooji.com/static/img/musicalNotes.png"/>', '<img src="http://tj.uooji.com/static/img/musicalNotes.png"/>', '<img src="http://tj.uooji.com/static/img/musicalNotes.png"/>'],
            steamHeight: 100,
            steamWidth: 50
