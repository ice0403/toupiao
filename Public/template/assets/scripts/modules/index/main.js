define(function(require, exports, module) {
    var $ = require("lib/zepto/zepto"), $ = require("modules/index/animationCloudBg"), $ = require("modules/index/meteorShower"), $indexPages = $(".page-index");
    module.exports = {
        init: function() {
            var $app = $("body");
            $indexPages.each(function(i, item) {
                console.log("index init"), $page = $(item), function() {
                    ...
                    $animationBox.is(".m-animationCloudBg") ? ($animationBox.animationCloudBg(), appBgClass = "appBg1") : $animationBox.is(".m-meteorShower") && ($animationBox.meteorShower({
                        starCount: 30,
                        meteorCount: 26
                    }), appBgClass = "appBg2"), $(window).on("load", function() {
